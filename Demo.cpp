...
void Demo::DrawColoredCubee()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(2.5, 3, 0));
...
void Demo::DrawColoredCubea()
{
	...
	model = glm::scale(model, glm::vec3(6, 0.5, 0.5));
...
void Demo::DrawColoredCubeo()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(5, 3, 0.5));

	model = glm::rotate(model, angle, glm::vec3(1, 0, 0));

	model = glm::scale(model, glm::vec3(0.5, 0.5, 3));
